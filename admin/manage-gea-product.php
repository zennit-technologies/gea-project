...
$sel_qry =  $conn->prepare("SELECT COUNT(*) as total, 
                (SELECT COUNT(*) FROM gea_product WHERE active=:active) as active, 
                (SELECT COUNT(*) FROM gea_product WHERE active=:in_active) as in_active,
                (SELECT COUNT(*) FROM gea_product WHERE created_at >= NOW() - INTERVAL 1 DAY) as last_get
            FROM gea_product");
...
<body class="main">
    ...
    <div class="content">
        <div class="top-bar">
            <!-- BEGIN: Breadcrumb -->
            <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="">Dashboard</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Manage GEA Product</div>
            <!-- END: Breadcrumb -->
                ...
                <div class="grid grid-cols-12 gap-6">
                    ...
                    <div class="col-span-12 mt-8">
                        <div class="intro-y flex items-center h-10">
                            ...
                            <button onclick="addNewData('add-gea-product')" class="btn btn-rounded-primary ml-3 mr-1 px-3"><i data-feather="plus-circle" class="report-box__icon text-theme-0 mr-3"></i> Add New GEA Product</button>
                        </div>
                            ...
                            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                <div class="report-box zoom-in">
                                    <div class="box p-5">
                                        ...
                                        <div class="text-base text-gray-600 mt-1">Active Products</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                <div class="report-box zoom-in">
                                    <div class="box p-5">
                                        ...
                                        <div class="text-base text-gray-600 mt-1">In-Active Products</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                <div class="report-box zoom-in">
                                    <div class="box p-5">
                                        ...
                                        <div class="text-base text-gray-600 mt-1">New Products (Last 24 Hours)</div>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        function fetch_data() {
            var dataTable = $('#manage_table').DataTable({
                ...
                'serverMethod': 'post',
                'ajax': {
                    'url': 'ajax/geaProduct/server-processing.php'
                },
                "order": [
                    [0, "desc"]
                ],
        ...
        const deleteGeaProduct = (id) => {
            if (Number.isInteger(id) && id != '') {
                if (confirm("Are You Sure, You Want to Delete?")) {
                    $.ajax({
                        type: "POST",
                        url: "ajax/geaProduct/getGeaProduct.php",
                        data: {
                            id
                        },
                        dataType: "JSON",
                        success: function(response) {
                            if (response.result == 1) {
                                $.ajax({
                                    type: "POST",
                                    url: "ajax/geaProduct/deleteGeaProduct.php",
                                    data: {
                                        id
                                    },
                                    dataType: "JSON",
        ...
        const editGeaProduct = (id) => {
            if (Number.isInteger(id) && id != '') {
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.result == 1) {
                            window.location.href = 'edit-gea-product';
                        } else {
                            toastr['error']("Not Found..");
                            setInterval(() => {
                                window.location.reload();
